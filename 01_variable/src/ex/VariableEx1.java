...
public class VariableEx1 {
	...
	public static void main(String[] args) {
		...
		// 변수 선언
		int num1;	// 메모리에 "int형" "정수"를 저장할 공간 "4byte"를 할당하고
		...
		// The local variable num1 may not have been 
		...
		// 2147483648L 또는 2147483648l 표시 == long으로 인식된다
		...
		double doubleNulm = 1.123456789;
		
		System.out.println("floatNum : " + floatNum);
		System.out.println("doubleNulm : " + doubleNulm);
		// floatNum : 1.1234568
		// doubleNulm : 1.123456789
		...
		System.out.println(System.identityHashCode(str2)); // hashCode : 주소 비슷	
