...
public class PolymorphismService {
	 ...
	 * 
	 * - "참조변수"가 참조하는 객체가
	 * 	 "클래스"로 만들어진 객체가 맞을 경우 true, 아님 false
	 * 
	 * - 상속 관계도 파악이 가능
	 * 	 (자식 객체 내부의 부모 객체도 인식)
	 */
...
//		else if(obj instanceof Object) {
	...
	public void test1() {
		...
		printObject(child);		// Object의 자식 타입인 Child 전달 가능
	}
	...
	public void test3() {
		...
		// (동적)String section01.dto.Parent.toString()
		System.out.println("p1.toString() : " + p1.toString());
		
		// (정적)String section01.dto.Child.toString()
		// (동적)String section01.dto.Child.toString()
