...
//		}
	...
	public void method5() {
		...
		boolean over = (num1 > num2);
	
		for(int i = (over ? num2 : num1); i <= (over ? num1 : num2); i++) {
			System.out.print(i + " ");
		}
		...
		if(num1 > num2) {
			int temp = num2;	// 임시 변수에 num2값 저
			num2 = num1;			// num2에 num1값 대
			num1 = temp;			// num1에 임시 변수에 저장한다
		}
